...
@section('content')
    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
        ...
        <div class="input-text form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="email" type="email" class="form-control reg-input reg-input-student" name="email" value="{{ old('email') }}" required autofocus>
        ...
        <div class="input-text form-group{{ $errors->has('password') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="password" type="password" class="form-control reg-input reg-input-student" name="password" required>
